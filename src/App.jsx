...
function App() {
  ...
  const [doneTyping, setDoneTyping] = useState(false) // ← FIXED here
      ...
      {section === 'about' && (
        <div className="about-section">
          ...
          <div className="about-text">
            <h2>{">"} About Me</h2>
            <p>Hi! I'm Japjeev Kaur, a sophomore majoring in Computer Science + Economics. I'm passionate about the intersection of technology and society, from full-stack development to cybersecurity and AI.</p>
